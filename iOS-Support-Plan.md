...
>
> *(Update: editing/checkboxes/Dynamic-Type/keyboard landed in Phase 2b; **syntax highlighting + LaTeX bridges**, then the **GFM tables compositor**, were subsequently ported to iOS and verified in the demo. Still out: horizontally-scrollable wide tables (`WideTableOverlay`), marked-text/IME, autocorrect lifecycle, context menus beyond the formatting menu.)*
